...
public class Exercises11_TheCircle2DClass {
    public static void main(String[] args) {
        ...
        System.out.println("Does circle1 contain the point (3, 3)? " +
                c1.contains(3, 3));
        System.out.println("Does circle1 contain the circlr centered at " +
                "(4, 5) and radius 10.5? " + c1.contains(new Circle2D(4, 5, 10.5)));
        System.out.println("Does circle overlap the circle centered at" +
                "(3, 5) and radius 2.3? " + c1.overlaps(new Circle2D(3, 5, 2.3)));
    }
}
//*********************************************************************************
